...
const App = () => {
    return (
        <div className="ui container comments">
            <CommentDetail author="Sam" date="Today at 6:00PM" commentary="Shut up!" avatar={faker.image.avatar()} />
            <CommentDetail author="Alex" date="Today at 5:42PM" commentary="Nice one!" avatar={faker.image.avatar()} />
            <CommentDetail author="Jane" date="Today at 3:33PM" commentary="Nice blog post!" avatar={faker.image.avatar()} />
        </div>
    );
};
